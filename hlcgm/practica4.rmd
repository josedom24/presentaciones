...
* Si creamos una nueva máquina virtual desde las **plantillas Linux**, vamos a usar el mecanismo de **Cloud-Init** para indicar **usuario/contraseña**.
...
1. Crea una nueva máquina llamada **maquina1** a partir de la plantilla de **Imágenes** **debian12-cloud**. Configúrala con el **Cloud-init** para crear un usuario con tu nombre, una nueva contraseña y para configurar tu clave SSH pública.
...
11. Para terminar crea una máquina Windows a partir de la plantilla de **Imágenes** **WindowsServer2019**.
...
11. Captura de pantalla del Windows Server 2019 funcionando.
