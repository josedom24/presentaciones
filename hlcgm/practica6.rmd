...
# Creación de un contenedoren Proxmox
...
1. Crea una nuevo contenedor a partir de la plantilla **Debian 12** que se llame **contenedor1**.
  * No indiques tu clave SSH pública en la creación.
...
5. Crea una nuevo contenedor a partir de la plantilla **Ubuntu 22.04** que se llame **contenedor2**.
  * Indica tu clave SSH pública en la creación.
