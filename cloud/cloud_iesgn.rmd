...
* Proxmox está pensado para que un "operador" cree máquinas virtuales que se van asignando a los usuarios. Pero configurable para que cada alumno trabaje con sus MV.
...
* OpenStack
  ...
  * Dos servidores de computación
    ...
    * Supermicro (AMD Opteron Processor 6220 - 16 núecleos) (128 Gb RAM) (HD convencional 1T)
