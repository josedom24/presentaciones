...
* Proxmox nos permite gestionar de forma sencilla virtualizar máquinas virtuales y LXC.
...
* Vamos a crear distintos **Pools de recursos**:
  * Un pool que se asigna a cada usuario. Nosotros lo hemos llamado *Proyecto de usuario*. Cada usuario creara sus recursos en su pool.
...
* Al grupo *Imágenes* le asignamos el rol **rol_imágenes**.
