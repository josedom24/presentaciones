...
* Tenemos que determinar la dirección IP del servidor de correo:
	...
	2. Si es un nombre de dominio (No tiene IP), es necesario en el servidor dns un **registro MX** que indique el nombre del servidor de correo asociado al nombre de dominio.
...
```
Nuestro servidor de correos es `satelite.gonzalonazareno.org` y accedemos a ella por la VPN:

```
# dig mail.gonzalonazareno.org
...
mail.gonzalonazareno.org. 86400	IN	CNAME	satelite.gonzalonazareno.org.
satelite.gonzalonazareno.org. 86400 IN	A	172.20.0.1
```
...
* **SMTPd restrintions**: Nuestro servidor puede hacer comprobaciones para restringir la recepción de correos: filtrar dominios de envío, filtrar quien puede hacer realy de nuestro servidor, filtrar si la IP del servidor de envío esta en una lista negra...
* Podemos comprobar el registro **SPF** y **DKIM** del servidor de envío.
